...
export default function Malaysia() {
  ...
  return (
    <div>
      ...
      <h1 className="turkey-tittle">Turkey Visa Online</h1>
      <div className="visa-tag1">
        <div className="icon">
    ...
    <div className="timing">
      ...
      <p className='hours'>Up to 30 hrs</p></span>

      <span className="processing-time">Starting from
      <p className='hours'>₹499/-</p></span>
      </div>
...
{/* 
        ...
        <div className="Types-of-visa1">

  <div className="visa_title">
  Types of Turkey Visas for Indians
  </div>
  <div className="Turkey_visa_card">
{/* Card1 */}
          <div className="turkey_card">
          <h4>30 days eVisa </h4>
  ...
  <form className="form1" action="https://api.web3forms.com/submit" method="POST">
...
<button type="reset" className="formButton_reset">Reset</button>
  ...
  <div className="turkey_visa">
    <p className='headoflist'>
Turkey Visa Price includes:
</p>
<ul className='listul'>
...
Depending on the purpose of your planned visit and duration of trip, you can apply for 96 hours, 14 days, 30 days (short term) or 90 days (long term) Turkey Visa (Single & Multiple entry). We are one of the leading Turkey Visa Experts offering Turkey visa for Indians at the lowest prices and with minimum documentation. Apply for your Turkey Tourist Visa online from cities like Mumbai, Delhi, Pune, Bangalore, Kochi, Hyderabad, Chennai, Amritsar & many more.
</p>
...
<div className="required_document">
  ...
  <div className="accordion-item">
    <h2 className="accordion-header">
      ...
      Must have Documents for Turkey eVisa:
      </button>
    </h2>
    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul>
          ...
          <li>Two (2) recent colour photographs taken against a white background</li>
 ...
 <h3>Visa Services - Terms & Conditions</h3> 
 <ol type="1">
